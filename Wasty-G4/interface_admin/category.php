<?php
  ...
  Ce fichier permet a l'administrateur de visualiser la liste des catégories d'objets, faire des recherches et ajouter,modifier ou supprimer des catégories .
  ...
  <body>
    ...
    <section class="wrapper">
      ...
      <section class="panel">
        ...
        <form class="form-horizontal " method="post" action="form_category.php">
          <div class="form-group">
            <label class="col-sm-2 control-label">Nom de catégorie</label>
            <div class="col-sm-10">
            ...
            <div class="col-lg-12">
              ...
              <div class="panel-body">
                ...
                <div class="modal-dialog">
                  ...
                  <form method="post" action="form_category.php">
