<?php
  ...
  Ce fichier permet a l'administrateur de visualiser la liste des quartiers , faire des recheches ,d'ajouter,modifier ou supprimer des quartiers .
          ...
          <div class="panel-body">
            <form class="form-horizontal " method="post" action="form_district.php">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="polygon" placeholder="Saisir le polygone" required>
                </div>
              </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="panel-body">
                ...
                <tbody>');
							...
							//recuperation du fichier JSON
							$string = file_get_contents("data/City/district.json");
							// transformation du fichier JSON en variable interpretable par PHP
							$json = json_decode($string, true);
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
   				  <form method = "post" action = "form_district.php">
